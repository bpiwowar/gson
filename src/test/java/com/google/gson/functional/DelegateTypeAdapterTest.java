...
public class DelegateTypeAdapterTest extends TestCase {
  ...
  private static class StatsTypeAdapterFactory implements AnnotatedTypeAdapterFactory {
    public int numReads = 0;
    public int numWrites = 0;

    public <T> TypeAdapter<T> create(Gson gson, TypeAttributes attributes, TypeToken<T> type) {
      final TypeAdapter<T> delegate = gson.getDelegateAdapter(this, attributes, type);
