 ...
 * @since 2.4
 */
public interface AnnotatedTypeAdapterFactory {

  /**
   * Returns a type adapter for field {@code field} of type {@code type},
   * or null if this factory doesn't support {@code type}.
   */
