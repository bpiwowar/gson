 ...
 * @since 2.3
 */
public final class JsonAdapterAnnotationTypeAdapterFactory implements AnnotatedTypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Gson gson, TypeAttributes f, TypeToken<T> targetType) {
