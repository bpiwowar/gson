 ...
 *
 * <p>The {@link #read(com.google.gson.stream.JsonReader) read()} method must read exactly one value
...
public abstract class TypeAdapter<T> {
   ...
   * {@code JsonReader} and call {@link #read(com.google.gson.stream.JsonReader)} for lenient reading.
   *
   * @return the converted Java object. May be null.
   * @since 2.2
   */
   ...
   * JsonReader} and call {@link #read(com.google.gson.stream.JsonReader)} for lenient reading.
   *
   * @return the converted Java object. May be null.
   * @since 2.2
   */
